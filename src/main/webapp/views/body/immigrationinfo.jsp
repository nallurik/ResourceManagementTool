				...
				<form class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="First Name">Type of Visa</label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="First Name">Reference Number</label>
							<div class="col-md-6">
								<div class="input-group">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="Secondary Occupation (if any)">Petitioning Employer Name</label>
							<div class="col-md-6">
								<div class="input-group">
									<div class="input-group-addon"> <i class="fa fa-id-card"></i> </div>
									<input id="statusExpiryDate" name="SCurrent Immigration Status" type="text" placeholder="Passport Number" class="form-control input-md">
